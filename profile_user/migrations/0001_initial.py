# Generated by Django 4.2.2 on 2023-07-01 03:04

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import profile_user.managers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified_by_phone', models.BooleanField(default=False, verbose_name='verified')),
            ...
            managers=[
                ('objects', profile_user.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
